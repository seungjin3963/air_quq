	...
	<div class="navbar navbar-expand-lg navbar-light bg-light mb-5">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a class="nav-link" href="/expOnline/expOnline">온라인 체험</a>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-4">
			<a href="" class="text-decoration-none">
				<img src="/resources/img/logo_bak.png" class="rounded-lg img-thumbnail">
		...
		<div class="col-md-4">
			<a href="" class="text-decoration-none">
				<img src="/resources/img/logo_bak.png" class="rounded img-thumbnail">
